...
DECLARE @DatabaseVersion nvarchar(20)='NoVer';
...
SET @backupstring='-SQL "BACKUP DATABASE ${flyway:database} TO DISK = ''C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\Backup\<AUTO>_'
					+@DatabaseVersion
				   +'.sqb'' WITH FILEOPTIONS = 4, PASSWORD = ''<OBFUSCATEDPASSWORD>Sze2ZdjGb2bgve00qg==</OBFUSCATEDPASSWORD>'', CHECKSUM, '
				  + 'DISKRETRYINTERVAL = 30, DISKRETRYCOUNT = 10, COMPRESSION = 4, COPYTO = ''\\millarchive\public\databaseBackups\Philf01'', INIT, KEYSIZE = 256, THREADCOUNT = 2"'
