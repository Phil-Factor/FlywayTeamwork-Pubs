...
DROP CONSTRAINT [FK__titles__pub_id__08EA5793]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
DROP CONSTRAINT [CK__authors__au_id__7F60ED59]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Dropping constraints from [dbo].[authors]'
...
ALTER TABLE dbo.authors 
/* authors of publications */
DROP CONSTRAINT [CK__authors__zip__014935CB]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Dropping constraints from [dbo].[authors]'
...
ALTER TABLE dbo.authors 
/* authors of publications */
DROP CONSTRAINT [DF__authors__phone__38996AB5]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
/* Job descriptions */
DROP CONSTRAINT [CK__jobs__max_lvl__1DE57479]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Dropping constraints from [dbo].[jobs]'
...
ALTER TABLE dbo.jobs 
/* Job descriptions */
DROP CONSTRAINT [CK__jobs__min_lvl__1CF15040]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Dropping constraints from [dbo].[jobs]'
...
ALTER TABLE dbo.jobs 
/* Job descriptions */
DROP CONSTRAINT [DF__jobs__job_desc__1BFD2C07]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.titles 
/* imitates legacy titles */
DROP CONSTRAINT [DF__titles__type__403A8C7D]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Dropping constraints from [dbo].[titles]'
...
ALTER TABLE dbo.titles 
/* imitates legacy titles */
DROP CONSTRAINT [DF__titles__pubdate__09DE7BCC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.employee 
/* a publishers employees */
ALTER COLUMN [pub_id] [char] (8) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.titles 
/* imitates legacy titles */
ALTER COLUMN [pub_id] [char] (8) NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
/* Current books etc */
ADD CONSTRAINT [PK_Publication] PRIMARY KEY CLUSTERED  ([Publication_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ADD CONSTRAINT [PK_editions] PRIMARY KEY CLUSTERED  ([Edition_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
/* price for each edition of a book */
ADD CONSTRAINT [PK_Prices] PRIMARY KEY CLUSTERED  ([Price_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.publishers 
/* client publishers */
ADD CONSTRAINT [CK__publisher__pub_id] CHECK (([pub_id]='1756' OR [pub_id]='1622' OR [pub_id]='0877' OR [pub_id]='0736' OR [pub_id]='1389' OR [pub_id] like '99[0-9][0-9]'))
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding constraints to [dbo].[authors]'
...
ALTER TABLE dbo.discounts 
/* bulk discounts */
ADD CONSTRAINT [FK__discounts__store] FOREIGN KEY ([stor_id]) REFERENCES [dbo].[stores] ([stor_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.prices 
/* price for each edition of a book */
ADD CONSTRAINT [fk_prices] FOREIGN KEY ([Edition_id]) REFERENCES [dbo].[editions] ([Edition_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.editions 
/* the editions of the publication */
ADD CONSTRAINT [fk_edition] FOREIGN KEY ([publication_id]) REFERENCES [dbo].[publications] ([Publication_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.employee 
/* a publishers employees */
ADD CONSTRAINT [FK__employee__job_id] FOREIGN KEY ([job_id]) REFERENCES [dbo].[jobs] ([job_id])
GO
ALTER TABLE dbo.employee 
/* a publishers employees */
ADD CONSTRAINT [FK__employee__pub_id] FOREIGN KEY ([pub_id]) REFERENCES [dbo].[publishers] ([pub_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.pub_info 
/* extended publisher info */
ADD CONSTRAINT [FK__pub_info__pub_id] FOREIGN KEY ([pub_id]) REFERENCES [dbo].[publishers] ([pub_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.publications 
/* Current books etc */
ADD CONSTRAINT [fkPublishers] FOREIGN KEY ([pub_id]) REFERENCES [dbo].[publishers] ([pub_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.titles 
/* imitates legacy titles */
ADD CONSTRAINT [FK__titles__pub_id] FOREIGN KEY ([pub_id]) REFERENCES [dbo].[publishers] ([pub_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.roysched 
/* royalty schedule */
ADD CONSTRAINT [FK__roysched__title] FOREIGN KEY ([title_id]) REFERENCES [dbo].[titles] ([title_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE dbo.titleauthor 
/* publication authors by order */
ADD CONSTRAINT [FK__titleauth__au_id] FOREIGN KEY ([au_id]) REFERENCES [dbo].[authors] ([au_id])
GO
ALTER TABLE dbo.titleauthor 
/* publication authors by order */
ADD CONSTRAINT [FK__titleauth__title] FOREIGN KEY ([title_id]) REFERENCES [dbo].[titles] ([title_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
