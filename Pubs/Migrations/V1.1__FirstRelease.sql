...
ADD CONSTRAINT PK_emp_id
    PRIMARY KEY NONCLUSTERED (emp_id) ON [PRIMARY];
GO
...
(
    ...
    job_desc varchar(50) COLLATE Latin1_General_CI_AS NOT NULL
...
ADD CONSTRAINT PK__jobs__6E32B6A51A14E395
    PRIMARY KEY CLUSTERED (job_id) ON [PRIMARY];
GO
...
ADD CONSTRAINT UPK_storeid
    PRIMARY KEY CLUSTERED (stor_id) ON [PRIMARY];
GO
...
(
    ...
    city varchar(20) COLLATE Latin1_General_CI_AS NULL,
    state char(2) COLLATE Latin1_General_CI_AS NULL,
    country varchar(30) COLLATE Latin1_General_CI_AS NULL
...
ADD CONSTRAINT UPKCL_pubind
    PRIMARY KEY CLUSTERED (pub_id) ON [PRIMARY];
GO
...
ADD CONSTRAINT UPKCL_titleidind
    PRIMARY KEY CLUSTERED (title_id) ON [PRIMARY];
GO
...
(
    ...
    phone char(12) COLLATE Latin1_General_CI_AS NOT NULL
...
ADD CONSTRAINT UPKCL_auidind
    PRIMARY KEY CLUSTERED (au_id) ON [PRIMARY];
GO
...
GO
ALTER TABLE dbo.authors
ADD CONSTRAINT CK__authors__au_id__7F60ED59 CHECK ((
...
GO
ALTER TABLE dbo.authors
ADD CONSTRAINT CK__authors__zip__014935CB CHECK ((
...
GO
ALTER TABLE dbo.jobs
ADD CONSTRAINT CK__jobs__min_lvl__1CF15040 CHECK ((
                                                     min_lvl >= (10)
                                                 ));
GO
...
GO
ALTER TABLE dbo.jobs
ADD CONSTRAINT CK__jobs__max_lvl__1DE57479 CHECK ((
                                                     max_lvl <= (250)
                                                 ));
GO
...
GO
ALTER TABLE dbo.publishers
ADD CONSTRAINT CK__publisher__pub_i__0425A276 CHECK ((
                                                        pub_id = '1756'
                                                        OR pub_id = '1622'
                                                        OR pub_id = '0877'
                                                        OR pub_id = '0736'
...
IF NOT EXISTS
(
    SELECT fn_listextendedproperty.name,
           fn_listextendedproperty.value
    FROM sys.fn_listextendedproperty(N'Database_Info', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT)
)
...
(N'BU1111', 'Cooking with Computers: Surreptitious Balance Sheets', 'business    ', '1389', 11.9500, 5000.0000, 10,
 3876, 'Helpful hints on how to use your electronic resources to the best advantage.', N'1991-06-09T00:00:00'),
...
(N'TC3218', 'Onions, Leeks, and Garlic: Cooking Secrets of the Mediterranean', 'trad_cook   ', '0877', 20.9500,
 7000.0000, 10, 375, 'Profusely illustrated in color, this makes a wonderful gift book for a cuisine-oriented friend.',
...
(N'PS1372', 'Computer Phobic AND Non-Phobic Individuals: Behavior Variations', 'psychology  ', '0877', 21.5900,
 7000.0000, 10, 375,
...
VALUES
('PC9999', 'Net Etiquette', 'popular_comp', '1389', 'A must-read for computer conferencing.');
