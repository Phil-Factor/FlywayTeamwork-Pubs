...
.EXAMPLE
    ...
    # Filter by a list of callback types (before, beforeEach, after, afterEach)
        .\scripts\Get-FlywayScriptAndCallbackChanges.ps1 -CallbackTypeRegex '^(before|after)'
    ...
    # Drill down as far back as specified date and format
        .\scripts\Get-FlywayScriptAndCallbackChanges.ps1 | Where-Object {$_.Date -gt '2025-01-01'} | Format-Table -AutoSize
    # Result Table 
